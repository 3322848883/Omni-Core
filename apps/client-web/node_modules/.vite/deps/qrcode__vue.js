...
function getImageSettings(cells, size, margin, imageSettings) {
  ...
  return { x, y, h: h2, w, borderRadius, excavation };
}
function useQRCode(props) {
  var margin = computed(function() {
    var _a;
    return ((_a = props.margin) !== null && _a !== void 0 ? _a : DEFAULT_MARGIN) >>> 0;
  });
  ...
  var numCells = computed(function() {
    return cells.value.length + margin.value * 2;
  });
...
var QrcodeCanvas = defineComponent({
  ...
  setup: function(props, ctx) {
    ...
    var drawRoundedRect = function(ctx2, x, y, width, height, radius) {
      ctx2.beginPath();
      if (ctx2.roundRect) {
        ctx2.roundRect(x, y, width, height, radius);
      } else {
...
var QrcodeVue = defineComponent({
  ...
  setup: function(props) {
    return function() {
      return h(props.renderAs === "svg" ? QrcodeSvg : QrcodeCanvas, {
        value: props.value,
        size: props.size,
        margin: props.margin,
        level: props.level,
